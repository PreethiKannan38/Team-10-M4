        ...
        <div className="min-h-screen bg-[#FAFAFC] flex items-center justify-center p-6 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-500 font-medium">Join our community of creators</p>
                </div>
                ...
                <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl shadow-indigo-50 border border-slate-50">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-4">Create Password</label>
                            <div className="relative group">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl py-4 font-black tracking-widest uppercase text-xs shadow-lg shadow-indigo-100 flex items-center justify-center gap-2 group transition-all hover:-translate-y-1 active:scale-95 disabled:opacity-50 mt-4"
                        >
